...
*Landing page institucional da Miguel Estética Automotiva — serviços, depoimentos e agendamento rápido via WhatsApp.*
...
| 📅 **Agendar** | Preencher formulário que monta uma mensagem pronta e envia direto para o **WhatsApp** |
...
├── main.js         → Lógica, modais, carrossel e envio de agendamento para WhatsApp
